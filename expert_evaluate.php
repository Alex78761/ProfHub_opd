...
// Получаем список профессий для оценки
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($profession_id && $relevance && $demand && $prospects) {
        try {
            ...
            $create_table_sql = "CREATE TABLE IF NOT EXISTS expert_evaluations (
            ...
            if ($result->num_rows > 0) {
                ...
                ");
                $stmt->bind_param("iiiisi", $relevance, $demand, $prospects, $comment, $_SESSION['user_id'], $profession_id);
            } else {
                ...
                $stmt = $conn->prepare("
                    ...
                    VALUES (?, ?, ?, ?, ?, ?)
                ");
                $stmt->bind_param("iiiisi", $_SESSION['user_id'], $profession_id, $relevance, $demand, $prospects, $comment);
            }
            ...
            <?php foreach ($professions as $profession): ?>
                <div class="profession-card">
                    ...
                    <form class="evaluation-form" method="POST" action="">
                        ...
                        <button type="submit" class="submit-btn">Сохранить оценку</button>
                    </form>
                </div>
            <?php endforeach; ?>
        <?php endif; ?>
